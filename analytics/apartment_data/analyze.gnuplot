set terminal postscript enhanced eps color font "Helvetica,14" size 12in,3in
...
# plot the data
plot 'apartment.dat' u ($1):($2) w lp ls 4 lc rgb "#2b83ba" title "1929 Plymouth"
