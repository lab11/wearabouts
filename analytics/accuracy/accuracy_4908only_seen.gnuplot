...
plot 'ground_truth_parsed.dat' u ($2):(($3==-1?0:1)+6.5) w l ls 1 title "ground truth", \
    wearabouts_file u ($2):(($3==-1?0:1)+6.5) w l ls 16 title "wearabouts", \
    'ground_truth_parsed.dat' u ($2):(($6==-1?0:1)+4.5) w l ls 4 notitle, \
    wearabouts_file u ($2):(($6==-1?0:1)+4.5) w l ls 16 notitle, \
    'ground_truth_parsed.dat' u ($2):(($4==-1?0:1)+2.5) w l ls 3 notitle, \
    wearabouts_file u ($2):(($4==-1?0:1)+2.5) w l ls 16 notitle, \
    'ground_truth_parsed.dat' u ($2):(($7==-1?0:1)+0.5) w l ls 5 notitle, \
    wearabouts_file u ($2):(($7==-1?0:1)+0.5) w l ls 16 notitle, \
