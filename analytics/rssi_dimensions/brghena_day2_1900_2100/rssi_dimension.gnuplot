...
plot data_file u ($2):($3) w p ls 11 title "vs 4901", \
     data_file u ($2):($4) w p ls 13 title "vs 4670", \
     data_file u ($2):($5) w p ls 14 title "vs 4916", \
     data_file u ($2):($6) w p ls 15 title "vs 4776", \
