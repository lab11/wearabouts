...
plot data_file u ($4):($2) w p ls 11 title "vs 4908", \
     data_file u ($4):($3) w p ls 13 title "vs 4901", \
     data_file u ($4):($5) w p ls 14 title "vs 4916", \
     data_file u ($4):($6) w p ls 15 title "vs 4776", \
