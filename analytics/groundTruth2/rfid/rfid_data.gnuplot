...
set output "rfid_data.eps"

camera_data_file = "../camera/camera_plottable.dat"
data_file = "rfid_plottable.dat"
...
set ytics mirror \
        ...
        "Absent" 10.5,  "sairohit" 11,  "Present" 11.5)
set yrange [0:12]

#plot \
#    camera_data_file u ($2):(($4==0?1:0)+0.5) w l ls 6 title "4908 camera", \
#    data_file u ($2):(($4==0?1:0)+0.5) w l ls 16 title "4908 rfid", \
#    \
...
plot \
    camera_data_file u ($2):(($4==0?1:0)+0.5) w l ls 6 title "4908 camera", \
    data_file u ($2):(($4==0?1:0)+0.5) w l ls 16 title "4908 rfid", \
    data_file u ($2):(($4==1?1:0)+0.5) w l ls 11 title "4901 rfid", \
    data_file u ($2):(($4==2?1:0)+0.5) w l ls 13 title "4670 rfid", \
    \
    camera_data_file u ($2):(($3==0?1:0)+2.5) w l ls 6 notitle, \
    data_file u ($2):(($3==0?1:0)+2.5) w l ls 16 notitle, \
    ...
    \
    camera_data_file u ($2):(($15==0?1:0)+10.5) w l ls 6 notitle, \
    data_file u ($2):(($15==0?1:0)+10.5) w l ls 16 notitle, \
    data_file u ($2):(($15==1?1:0)+10.5) w l ls 11 notitle, \
    data_file u ($2):(($15==2?1:0)+10.5) w l ls 13 notitle, \
    \
